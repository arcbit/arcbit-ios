...
class ArcBitTests: XCTestCase {
    ...
    func testCreateSignedSerializeTransactionHex() {
        ...
        let txSize = txHexAndTxHash.objectForKey("txSize") as! NSNumber
        ...
        XCTAssertTrue(txSize.unsignedIntegerValue == 193)
    }
    ...
    func testCreateSignedSerializedTransactionHexAndBIP69() {
        ...
        imports.setObject(NSMutableArray(), forKey: "imported_accounts")
        imports.setObject(NSMutableArray(), forKey: "imported_private_keys")
        imports.setObject(NSMutableArray(), forKey: "watch_only_accounts")
        imports.setObject(NSMutableArray(), forKey: "watch_only_addresses")
        ...
        hdWallet.setObject(0, forKey: "current_account_id")
        hdWallet.setObject(0, forKey: "master_hex")
        hdWallet.setObject(1, forKey: "max_account_id_created")
        hdWallet.setObject("default", forKey: "name")
        hdWallet.setObject(backupPassphrase, forKey: "passphrase")
        
        var accounts = NSMutableArray()
        var accountDict = NSMutableDictionary()
        accountDict.setObject(0, forKey: "account_idx")
        ...
        changeAdress.setObject(0, forKey: "index")
        changeAdress.setObject(1, forKey: "status")
        changeAdresses.addObject(changeAdress)
        accountDict.setObject(changeAdresses, forKey: "change_addresses")
        
        var mainAddresses = NSMutableArray()
        var mainAddress = NSMutableDictionary()
        mainAddress.setObject(mainAddress0, forKey: "address")
        mainAddress.setObject(0, forKey: "index")
        mainAddress.setObject(1, forKey: "status")
        mainAddresses.addObject(mainAddress)
        accountDict.setObject(mainAddresses, forKey: "main_addresses")
        
        accountDict.setObject(0, forKey: "min_change_address_vidx")
        accountDict.setObject(0, forKey: "min_main_address_idx")
        accountDict.setObject("Account 1", forKey: "name")
        accountDict.setObject(0, forKey: "needs_recovering")
        accountDict.setObject(1, forKey: "status")
        
        
        var stealthAddresses = NSMutableArray()
        var stealthAddress = NSMutableDictionary()
        stealthAddress.setObject(0, forKey: "last_tx_time")
        stealthAddress.setObject(NSMutableArray(), forKey: "payments")
        stealthAddress.setObject("NOTUSED", forKey: "scan_key")
        var servers = NSMutableDictionary()
        var watching = NSMutableDictionary()
        watching.setObject(1, forKey: "watching")
        servers.setObject(watching, forKey: "www.arcbit.net")
        stealthAddress.setObject(servers, forKey: "servers")
        stealthAddress.setObject("NOTUSED", forKey: "spend_key")
        stealthAddress.setObject("NOTUSED", forKey: "stealth_address")
        stealthAddresses.addObject(stealthAddress)
        
        accountDict.setObject(stealthAddresses, forKey: "stealth_addresses")
        ...
        hdWallet.setObject(accounts, forKey: "accounts")
        hdWallets.addObject(hdWallet)
        
        wallet.setObject(hdWallets, forKey: "hd_wallets")
        wallet.setObject(NSMutableArray(), forKey: "address_book")
        wallet.setObject(imports, forKey: "imports")
        wallet.setObject(NSMutableArray(), forKey: "tx_tags")
        ...
        let mockUnspentOutput = { (txid: String, value: UInt64, txOutputN: Int) -> NSDictionary in
            ...
            unspentOutput.setObject(NSNumber(unsignedLongLong: value), forKey: "value")
            unspentOutput.setObject(6, forKey: "confirmations")
        ...
        func testCreateSignedSerializedTransactionHexAndBIP69_1() -> () {
            ...
            func testCreateSignedSerializedTransactionHexAndBIP69_1_1() -> () {
                ...
                XCTAssertTrue(txSize.unsignedIntegerValue == 376)
        ...
        func testCreateSignedSerializedTransactionHexAndBIP69_2() -> () {
            ...
            func testCreateSignedSerializedTransactionHexAndBIP69_2_1() -> () {
                ...
                accountObject.unspentOutputs!.addObject(unspentOutput0)
                accountObject.unspentOutputs!.addObject(unspentOutput1)
                accountObject.unspentOutputs!.addObject(unspentOutput2)
                accountObject.unspentOutputs!.addObject(unspentOutput3)
                accountObject.unspentOutputs!.addObject(unspentOutput4)
                accountObject.unspentOutputs!.addObject(unspentOutput5)
                accountObject.unspentOutputs!.addObject(unspentOutput6)
                accountObject.unspentOutputs!.addObject(unspentOutput7)
                accountObject.unspentOutputs!.addObject(unspentOutput8)
                accountObject.unspentOutputs!.addObject(unspentOutput9)
                accountObject.unspentOutputs!.addObject(unspentOutput10)
                accountObject.unspentOutputs!.addObject(unspentOutput11)
                accountObject.unspentOutputs!.addObject(unspentOutput12)
                accountObject.unspentOutputs!.addObject(unspentOutput13)
                accountObject.unspentOutputs!.addObject(unspentOutput14)
                accountObject.unspentOutputs!.addObject(unspentOutput15)
                accountObject.unspentOutputs!.addObject(unspentOutput16)
                ...
                XCTAssertTrue(txSize.unsignedIntegerValue == 2611)
        ...
        func testCreateSignedSerializedTransactionHexAndBIP69_3() -> () {
            ...
            func testCreateSignedSerializedTransactionHexAndBIP69_3_1() -> () {
                ...
                XCTAssertTrue(txSize.unsignedIntegerValue == 410)
        ...
        func testCreateSignedSerializedTransactionHexAndBIP69_4() -> () {
            ...
            func testCreateSignedSerializedTransactionHexAndBIP69_4_1() -> () {
                ...
                XCTAssertTrue(txSize.unsignedIntegerValue == 2645)
        ...
        func testCreateSignedSerializedTransactionHexAndBIP69_5() -> () {
            ...
            func testCreateSignedSerializedTransactionHexAndBIP69_5_2() -> () {
                ...
                XCTAssertTrue(txSize.unsignedIntegerValue == 227)
